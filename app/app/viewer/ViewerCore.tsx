        ...
        viewer.on(ViewerEvent.ObjectClicked, (selectionEvent: any) => {
          ...
          if (selectionEvent && selectionEvent.hits && selectionEvent.hits.length > 0) {
            ...
            if (hit && hit.node) {
              ...
              // Safely access the event properties with fallback
              const originalEvent = selectionEvent.event || selectionEvent.originalEvent || {};
              const isMultiSelect = originalEvent.ctrlKey || originalEvent.metaKey || false;

              console.log("🎮 Multi-select mode:", isMultiSelect, "Event:", originalEvent);
          ...
          <div className="selection-indicator">
            ...
            <span>
              {selectedElements.length === 1 
                ? `Selected: ${selectedElements[0].name || selectedElements[0].type}` 
        ...
        {!isLoading && selectedElements.length === 0 && (
          <div className="selection-helper">
            <div className="helper-text">
              💡 Hold <kbd>Ctrl</kbd> (or <kbd>⌘</kbd> on Mac) + click to select multiple elements
            </div>
          </div>
        )}
