...
export default function MyApp({ Component, pageProps }: AppProps) {
  ...
  // Check if we're on a viewer page (which needs locked viewport)
  const isViewerPage = router.pathname.startsWith('/viewer');
    ...
    <>
      ...
      <style jsx global>{`
        ...
        *:focus-visible {
        ...
        #__next {
          height: ${isViewerPage ? '100vh' : 'auto'};
          width: 100%;
          /* Lock viewport only for 3D viewer pages, allow scrolling everywhere else */
          overflow: ${isViewerPage ? 'hidden' : 'auto'};
        }
